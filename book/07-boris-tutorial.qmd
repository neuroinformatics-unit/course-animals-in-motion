...
You will also need the files `mouse044_task1_annotator1.mp4` and `mouse044_task1_mount_events_boris.tsv` downloaded from [Dropbox](https://www.dropbox.com/scl/fo/81ug5hoy9msc7v7bteqa0/AH32RLdbZqWZJstIeR4YHZY?rlkey=blgagtaizw8aac5areja6h7q1&st=xni448zl&dl=0) (see [prerequisites @sec-data]). If you have gone through @sec-sleap, you should already have these files.
...
Open the TSV file you exported in Excel, Google Sheets, LibreOffice Calc, Numbers, or any text editor. Compare it with the ground-truth annotations provided as `mouse044_task1_mount_events_boris.tsv`, which are also shown here for your convenience (only the importand columns are displayed):
...
df[show_columns].head(n_rows)
```

- How did your annotations differ from the ground truth?
- Did you miss any bouts or found some extra ones?
