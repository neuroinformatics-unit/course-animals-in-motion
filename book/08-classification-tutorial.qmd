...
Overall, we get an **accuracy** of about **84%**, meaning our classifier gets 84% of frames right. But note this can be misleading in an imbalanced dataset like ours. Since only ~21% of frames are mounts, a classifier that *always* predicts "non mount" would already have ~79% accuracy, even if predicted incorrectly all "mount" frames. This is way for imbalanced datasets, precision, recall and F1 are more informative than accuracy alone. 
...
<!-- Our second classifier: a random forest -->
<!-- * What is a random forest? -->
<!-- * Why not pass raw keypoints? (features, feature engineering) -->
## Add more features
