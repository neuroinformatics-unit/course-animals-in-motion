...
- **CalMS21**: Contains an example video from the [Caltech Mouse Social Interactions (CalMS21) Dataset](https://sites.google.com/view/computational-behavior/our-datasets/calms21-dataset) [@sun_caltech_2021], SLEAP labels and trained models, as well as BORIS-compatible annotations of "mount" events.
  ...
  - **mouse044_task1_annotator1.slp**: Fully annotated SLEAP labels file containing 3394 labelled frames (converted from `calms21_task1_train.json`). The train/test splits above were derived from this file using a 20:80 random partition.
  - **mouse044_task1_mount_events_boris.tsv**: Ground-truth annotations of "mount" events in the video, extracted from `calms21_task1_train.json` to a BORIS-compatible TSV format.
