...
Please install [SLEAP](https://sleap.ai/) following the official [SLEAP pip installation guide](https://docs.sleap.ai/v1.6.3/installation/#pip-installation).

You can [verify the installation](https://docs.sleap.ai/v1.6.3/installation/#verify-installation) by running `sleap doctor`.

::: {.callout-note}
The installation command installs the latest SLEAP version. To install a specific version, append `==<version>` to the package name, e.g. `sleap[nn]==1.6.3`. For this workshop, use **version 1.6.3**.
:::
