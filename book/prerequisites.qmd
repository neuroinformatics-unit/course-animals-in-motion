...
You will also need a separate `conda` environment for the tutorials and case studies involving [movement](https://movement.neuroinformatics.dev/). This environment includes `movement` itself as well as [jupyter](https://jupyter.org/) (required for following along interactively and solving the exercises) and [scikit-learn](https://scikit-learn.org/stable/) (required for the chapter on supervised classification).
