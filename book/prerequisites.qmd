...
- [Python](https://carpentries.github.io/workshop-template/install_instructions/#python), via the [conda-forge installer](https://conda-forge.org/download/). Please make sure you install **Python 3.13**.
...
Please install [SLEAP](https://sleap.ai/) following the official [SLEAP installation guide](https://docs.sleap.ai/latest/installation/).

The recommended method is to use [uv](https://docs.astral.sh/uv/), as described in the guide. 
Alternatively, if you prefer using `conda` with `pip`, you can follow [SLEAP's pip installation guide](https://docs.sleap.ai/v1.6.3/installation/#pip-installation).

::: {.callout-note}
For this workshop, use **SLEAP version 1.6.3**. The official installation guide may show a different version number. When following those instructions, replace any version numbers with the ones below:
