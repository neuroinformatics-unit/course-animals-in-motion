...
In response to these challenges, we recognised the need for a versatile, easy-to-use toolbox that is compatible with modern ML-based motion-tracking frameworks and supports interactive data exploration and analysis.
...
### Load a dataset {#sec-movement-load}
...
To load the data, we pass the above path to `movement`'s [`load_dataset`](https://movement.neuroinformatics.dev/latest/api/movement.io.load.load_dataset.html) function.
