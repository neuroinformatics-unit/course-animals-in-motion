...
[sample data](https://movement.neuroinformatics.dev/latest/user_guide/input_output.html#sample-data)
...
Consult the [GUI user guide](https://movement.neuroinformatics.dev/latest/user_guide/gui.html)
