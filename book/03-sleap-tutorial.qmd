...
For convenience, a better-performing model&mdash;trained on over 600 labelled frames&mdash;is available for download from [Dropbox](https://www.dropbox.com/scl/fo/81ug5hoy9msc7v7bteqa0/AH32RLdbZqWZJstIeR4YHZY?rlkey=blgagtaizw8aac5areja6h7q1&st=w1zueyi9&dl=0) (see [prerequisites @sec-data]). 
This model can be used directly for inference.
