...
For assembling a set of frames for annotation, you can either pick your own frames, or let SLEAP suggest a set of frames using the "Labeling Suggestions" panel. The full list of suggestion methods can be found [here](https://sleap.ai/guides/gui.html#suggestion-methods).
