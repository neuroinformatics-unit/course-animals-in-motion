...
![SLEAP GUI create project](img/SLEAP/1_create_project.png){width=100%}
...
![Mouse body parts annotations](https://neuroinformatics.dev/course-behavioural-analysis/img/mouse-annotated.png){fig-align="center" width="40%"}
...
![SLEAP GUI define skeleton](img/SLEAP/2_define_skeleton.png){width=100%}
...
![SLEAP GUI sample frames](img/SLEAP/3_sample_frames.png){width=100%}
...
![SLEAP GUI label frames](img/SLEAP/4_label_frames.png){width=100%}
...
![SLEAP GUI configure training](img/SLEAP/5_config_model.png){width=100%}

Configure the **Centroid model** that predicts the location of each animal in each frame.

![SLEAP GUI configure centroid model](img/SLEAP/5_config_model_centroid.png){width=100%}
...
![SLEAP GUI configure pose and ID model](img/SLEAP/5_config_model_id.png){width=100%}
...
![SLEAP GUI train centroid model](img/SLEAP/5_train_model_centroid.png){width=100%}

![SLEAP GUI train pose and ID model](img/SLEAP/5_train_model_id.png){width=100%}

### Evaluate trained models

![SLEAP GUI evaluate model](img/SLEAP/6_evaluate_model.png){width=100%}
