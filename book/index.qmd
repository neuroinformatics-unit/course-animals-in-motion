...
Non-development versions are also available with answers to exercises which can be accessed by appending `-answers` to the version name in the URL.
For example, answers for the `v2025.08a2` version are available at <https://animals-in-motion.neuroinformatics.dev/v2025.08a2-answers/>.
