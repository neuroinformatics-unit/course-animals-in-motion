...
^*^*A companion `-answers` build is also available for these versions, e.g. `v2025.10-answers`. These are historical archives: later versions include solutions in the main build, at the end of each chapter.*
